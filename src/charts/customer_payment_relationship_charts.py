...
def create_customer_payment_comprehensive_dashboard(df: pd.DataFrame):
    """Cross-tabulation chart showing customer category vs payment method relationship"""
    ...
    fig.update_layout(
        title=f'Tỷ lệ KH/Thanh toán (%)<br>Tổng quan: {total_customers:,} giao dịch - Chi tiêu TB: {avg_spending:,.0f} £',
